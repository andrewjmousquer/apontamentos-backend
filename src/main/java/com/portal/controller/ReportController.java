...
@Tag(name = "Report", description = "Report Entity controller")
@CrossOrigin(origins = "*")
public class ReportController extends BaseController {
	...
	public ResponseEntity<List<ReportModel>> listAll(@RequestHeader("Authorization") String token)
	...
	public ResponseEntity<List<ReportModel>> listAllFolders(@RequestHeader("Authorization") String cookie)
			throws AppException, BusException {
