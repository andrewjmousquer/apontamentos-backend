...
@Tag(name = "Parameter", description = "Parameter Entity controller")
@CrossOrigin(origins = "*")
public class ParameterController extends BaseController {
	...
	public ResponseEntity<List<ParameterModel>> search(@Valid @RequestBody ParameterModel model)
	...
	public ResponseEntity<ParameterModel> save(@Valid @RequestBody ParameterModel model, BindingResult result)
			throws AppException, BusException {
