...
@Tag(name = "Holding", description = "Holding Entity controller")
@CrossOrigin(origins = "*")
public class HoldingController extends BaseController {
	...
	public ResponseEntity<List<HoldingModel>> search(@Valid @RequestBody HoldingModel model)
	...
	public ResponseEntity<HoldingModel> save(@Valid @RequestBody HoldingModel model, BindingResult result)
			throws AppException, BusException {
	 ...
	 */
	@PutMapping(value = "/{id}")
	public ResponseEntity<HoldingModel> update(@PathVariable("id") Integer id,
			@Valid @RequestBody HoldingModel HoldingModel, BindingResult result)
