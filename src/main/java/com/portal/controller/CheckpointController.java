...
@Tag(name = "Checkpoint", description = "Checkpoint Entity controller")
@CrossOrigin(origins = "*")
public class CheckpointController extends BaseController {
	...
	public ResponseEntity<List<CheckpointModel>> search(@Valid @RequestBody CheckpointModel model)
	...
	public ResponseEntity<CheckpointModel> save(@Valid @RequestBody CheckpointModel model, BindingResult result)
			throws AppException, BusException {
