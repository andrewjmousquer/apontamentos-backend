...
@Tag(name = "Access List", description = "AccessList Entity controller")
@CrossOrigin(origins = "*")
public class AccessListController extends BaseController {
	...
	public ResponseEntity<List<AccessListModel>> search(@Valid @RequestBody AccessListModel model)
	...
	public ResponseEntity<AccessListModel> save(@Valid @RequestBody AccessListModel model, BindingResult result)
			throws AppException, BusException {
