...
@Tag(name = "Customer", description = "Customer Entity controller")
@CrossOrigin(origins = "*")
public class CustomerController extends BaseController {
	...
	public ResponseEntity<List<CustomerModel>> search(@Valid @RequestBody CustomerModel model)
	...
	public ResponseEntity<CustomerModel> save(@Valid @RequestBody CustomerModel model, BindingResult result)
			throws AppException, BusException {
	 ...
	 */
	@PutMapping(value = "/{id}")
	public ResponseEntity<CustomerModel> update(@PathVariable("id") Integer id,
			@Valid @RequestBody CustomerModel customerModel, BindingResult result)
			throws NoSuchAlgorithmException, AppException, BusException {
